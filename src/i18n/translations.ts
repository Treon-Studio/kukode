...
export const ui = {
  en: {
    ...
    'about.desc':
      'Learn about Kukode, a community-driven index and platform for modern design and front-end development.',
    'about.p1':
      'Kukode is a community-driven platform for designers, developers, and creative professionals who take their craft seriously. It’s a place to stay current — from design systems and typography to modern front-end tools and workflows.',
    'about.p2':
      'Beyond resources, Kukode functions as a living creative index. Members share work, exchange ideas, and learn from real-world experience. Curated collections, focused articles, tutorials, and trend breakdowns are built to improve decision-making, not just inspire it.',
    'about.p3':
      'Good work doesn’t happen in isolation. Kukode is designed to connect forward-thinking creatives, encourage critical thinking, and push standards higher. Join the community and use it to sharpen your skills, expand your perspective, and build better work.',
    'about.quote':
      '"Innovation is born from connection. Together, we create the future of design."',
    'about.author': 'Jordan Miller, Founder of Kukode',
  ...
  id: {
    ...
    'about.desc':
      'Pelajari tentang Kukode, indeks dan platform berbasis komunitas untuk desain modern dan pengembangan front-end.',
    'about.p1':
      'Kukode adalah platform berbasis komunitas untuk desainer, pengembang, dan profesional kreatif yang menganggap serius keahlian mereka. Ini adalah tempat untuk tetap mengikuti perkembangan terbaru — mulai dari sistem desain dan tipografi hingga alat bantu front-end dan alur kerja modern.',
    'about.p2':
      'Selain sumber daya, Kukode berfungsi sebagai indeks kreatif yang hidup. Anggota berbagi karya, bertukar ide, dan belajar dari pengalaman dunia nyata. Koleksi yang dikurasi, artikel terfokus, tutorial, dan rincian tren dibuat untuk meningkatkan pengambilan keputusan, bukan hanya menginspirasi.',
    'about.p3':
      'Karya yang baik tidak terjadi dalam isolasi. Kukode dirancang untuk menghubungkan para kreatif yang berpikiran maju, mendorong pemikiran kritis, dan mendorong standar yang lebih tinggi. Bergabunglah dengan komunitas dan gunakan untuk mengasah keterampilan Anda, memperluas perspektif Anda, dan membangun karya yang lebih baik.',
    'about.quote':
      '"Inovasi lahir dari koneksi. Bersama-sama, kita menciptakan masa depan desain."',
    'about.author': 'Jordan Miller, Pendiri Kukode',
