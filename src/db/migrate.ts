      ...
      embeds: [
        {
          ...
          description: "Perubahan skema database (migration) telah berhasil diterapkan pada database Turso.",
      ...
      embeds: [
        {
          ...
          description: "Terjadi kesalahan saat menerapkan perubahan skema (migration) pada database Turso.",
